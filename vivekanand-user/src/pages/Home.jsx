          ...
          <div className="grid grid-cols-1 lg:grid-cols-[52%_48%] gap-8 lg:gap-12 items-center">
            ...
            <Reveal>
              <div className="inline-block mb-2">
                ...
                <span className="block font-heading text-[48px] sm:text-[68px] lg:text-[80px] font-black text-[#FFD54F] !leading-[1.8] mt-1 pb-4 pt-2">
                  2026-27
                </span>
              </div>
              <h1 className="font-heading font-extrabold text-[28px] sm:text-[36px] lg:text-[42px] !leading-loose text-[#FFE082] mt-3 pb-4 pt-2">
                ...
                <Reveal key={course._id || course.id} delay={i * 0.1}>
                  <div className="card-hover border border-border bg-white overflow-hidden h-full flex flex-col shadow-sm">
                    ...
                    <div className="bg-[#640D0D] text-white p-5 relative flex items-center gap-3">
                      ...
                      <h3 className="font-heading font-extrabold text-[18px] text-white !leading-loose pb-2 pt-1">
                        {course.name}
                      </h3>
                    </div>
